                    ...
                    <div className="row product-adding">
                        <Formik
                            initialValues={{
                                ...
                                product_name: '',
                                product_sku: '',
                                product_categories: this.state.proCategories,
                                sort_summery: '',
                                status: '',
                                description: '',
                                meta_title: '',
                            ...
                            validationSchema={Yup.object().shape({
                                ...
                                product_image: Yup.mixed().required('Product Image is Required.').test("fileFormat",
                            ...
                            onSubmit={(values, { setStatus, setSubmitting, resetForm }) => {
                                ...
                                formData.append("product_qty",values.product_quantity);
                                ...
                                apiservice.createWithForm('catalog/products/add', formData)
                                    .then(val => {
                                        setSubmitting(false);
                                        if(val){
